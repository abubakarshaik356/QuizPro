...
<head>
    ...
    <style>
        ...
        .tab-button {
            ...
            margin-bottom: -2px; /* Pulls button slightly down to align with bottom border */
        }
        .tab-button.active {
        ...
        .action-button.publish { color: var(--success-color); }
        ...
        .badge.published { background-color: #d4edda; color: var(--success-color); }
        .badge.draft { background-color: #fff3cd; color: var(--warning-color); }
        .badge.review { background-color: #cfe2ff; color: var(--primary-color); }
        ...
        @media (max-width: 992px) {
            ...
            .content-controls { flex-direction: column; align-items: stretch; gap: 15px; }
            .content-controls input { width: 100%; }
        }
    </style>
</head>
<body>
    ...
    <div class="admin-layout">
        ...
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="ContentManagement" class="active"><i class="fas fa-puzzle-piece"></i> Content Management</a>
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <p>Manage quizzes, categories, questions, and learning paths across the platform.</p>
            </div>

            <div class="tabs">
                <button class="tab-button active" onclick="openContent(event, 'Quizzes')"><i class="fas fa-clipboard-list"></i> Quizzes</button>
                <button class="tab-button" onclick="openContent(event, 'Categories')"><i class="fas fa-list-alt"></i> Categories</button>
            </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="action-button"><i class="fas fa-edit"></i> Edit</button>
                                    <button class="action-button publish"><i class="fas fa-eye"></i> Show</button>
                                </td>
                            </tr>
                            <% } %>
                        </tbody>
