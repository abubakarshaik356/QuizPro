...
<body>
	<%
		...
		User user=adminDAO.getUserDetails(id);
	%>
	<div class="admin-layout">
		...
		<main class="main-content">
			<div class="page-header">
				...
				<h1>Edit Existing User Account</h1>
			...
			<div class="form-card">
				...
				<form action="EditUser" method="POST">
					...
					<div class="form-group">
						<label for="userId"><i class="fas fa-key"></i> User ID</label> <input
							type="text" id="userId" name="userId"
							value="<%=user.getUserid() %>" readonly> <small>This
							unique ID is assigned by the system upon submission.</small>
					</div>
					...
					<div class="form-group">
						...
						<input type="email" id="email" name="email"
							value="<%=user.getEmail() %>" required> <small>This
					...
					<div class="form-group">
						<label for="role"><i class="fas fa-shield-alt"></i> User
							...
							<option value="user" <% if (user.getRole().equals("user")) { %>
								selected <% } %>>Standard User</option>

							<option value="admin" <% if (user.getRole().equals("admin")) { %>
								selected <% } %>>Administrator (Full Access)</option>
					...
					<div class="form-group">
						<label for="mobileNumber"><i class="fas fa-phone"></i>
							Mobile Number</label> <input type="text" id="mobileNumber" name="phone"
