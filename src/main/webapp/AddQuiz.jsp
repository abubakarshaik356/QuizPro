    ...
    <div class="admin-layout">
        ...
        <main class="main-content">
            ...
            <div class="form-card">
                ...
                <form action="AddNewQuizintoTable" method="GET"> 
                    
                    <div class="form-group">
                        <label for="title"><i class="fas fa-heading"></i> Quiz Title</label>
                        <input type="text" id="title" name="title" placeholder="e.g., Python Data Structures Deep Dive" required>
                        <small>The main title visible to users.</small>
                    </div>

                    <div class="form-group">
                        <label for="description"><i class="fas fa-file-alt"></i> Short Description</label>
                        <textarea id="description" name="description" placeholder="A brief summary of the topics covered in this quiz..." required></textarea>
